---
title: "Vignette cellviz3d - mgx meshes"
...
```{r echo=FALSE}
knitr::include_graphics(system.file("extdata", "mgx/img/p1labels.png", package = "cellviz3d"))
```
...
```{r echo=FALSE}
knitr::include_graphics(system.file("extdata", "mgx/img/timeserie800ms.gif", package = "cellviz3d"))
```
